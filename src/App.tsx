        ...
        <main className="flex-1 flex flex-col relative h-full min-w-0 p-4 gap-4">
          ...
          <header className="h-16 flex justify-between items-center px-6 shrink-0 border border-[var(--border-nav)] bg-[var(--header-bg)] backdrop-blur-md z-30 transition-all rounded-[20px] shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <button className="hidden sm:flex w-8 h-8 bg-black/5 rounded-lg text-[var(--text-nav-dim)] items-center justify-center hover:bg-black/10 transition-colors">‹</button>
            </div>
            ...
            <div className="flex justify-end gap-3 sm:gap-5 items-center text-[var(--text-nav-dim)]">
              ...
              <button className="hover:text-[var(--text-nav)] font-bold text-[var(--text-nav-dim)] hidden sm:block">?</button>
              <button
              ...
              <button className="hover:text-[var(--text-nav)] text-lg hidden sm:block transition-colors">⛶</button>
            </div>
          </header>
